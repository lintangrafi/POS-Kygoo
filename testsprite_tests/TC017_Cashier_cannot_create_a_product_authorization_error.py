...
async def run_test():
    ...
    try:
        ...
        # -> Sign in as the seeded cashier user.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div[2]/div[2]/div[2]/form/div/input').nth(0)
        await asyncio.sleep(3); await elem.fill('cashier@kygoo.studio')
        ...
        # -> Navigate to Inventory and verify access is blocked for cashier.
        await asyncio.sleep(2)
        await page.goto("http://localhost:3000/dashboard/inventory")
        
        # --> Assertions to verify final state
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Not authorized')]").nth(0).is_visible(), "Expected 'Not authorized' to be visible"
